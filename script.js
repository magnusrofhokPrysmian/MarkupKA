...
//https://prysmiangroup.sharepoint.com/sites/NE-Scandinavia-CuttingControl/Lists/Artiklar/AllItems.aspx

async function fetchSharePointArticles() {
    const url = "https://prysmiangroup.sharepoint.com/sites/NE-Scandinavia-CuttingControl/_api/web/lists/getbytitle('Artiklar')/items?$select=Description,SAP_x0020_code";
    ...
    const response = await fetch(url, {
        ...
        credentials: "include" // uses your existing Microsoft 365 login
    });
    ...
    return data.d.results.map(item => ({
        ...
        SAPCode: item.SAP_x0020_code
    }));
}

async function processArticleTable() {
	const articleTable = await fetchSharePointArticles();
